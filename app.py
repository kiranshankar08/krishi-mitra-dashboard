...
<style>
    ...
    /* ============================================================
       ...
       Tightens spacing/sizing on narrow (phone) screens so the
       dashboard doesn't feel like a squished desktop layout.
       ============================================================ */
    @media (max-width: 640px) {
        ...
        .weather-banner-rain, .weather-banner-clear,
        .dose-banner, .crop-banner, .savings-banner {
        ...
        /* Streamlit's own column gap is wide by default; tighten on mobile */
...
# =========================================================
# METRICS ROW 1  (was 6 columns -> now two rows of 3 for mobile)
# =========================================================
...
# =========================================================
# METRICS ROW 2  (was 6 columns -> now two rows of 3 for mobile)
# =========================================================
...
# On mobile these stack vertically (Streamlit default) which is fine
# since each is a self-contained visual block.
# =========================================================
...
# =========================================================
# HISTORICAL TRENDS ROW  (was 6 columns -> now two rows of 3 for mobile)
# =========================================================
...
if len(df) >= 2 and "soil" in df.columns and "dose_factor" in df.columns:
    ...
    # Savings metrics row  (was 4 columns -> now 2x2 for mobile)
    w1, w2 = st.columns(2)
